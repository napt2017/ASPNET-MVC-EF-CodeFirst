...
namespace ASPNET_MVC_EF_CodeFirst.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
